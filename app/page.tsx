...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-[#2d2d2d] to-[#1a1a1a] py-28 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#9B7E6B] rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#D4C4B0] rounded-full blur-3xl"></div>
        </div>
        <div className="max-w-[1500px] mx-auto px-8 md:px-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mb-20">
            <div className="space-y-8">
              <div className="text-[48px] font-extralight tracking-[0.25em] text-white mb-6">
                CLOVER
              </div>
              <p className="text-[17px] text-[#D4C4B0] font-light leading-relaxed max-w-sm">
                Moda consciente y atemporal en el corazón de Barcelona. Cada pieza cuenta una historia.
              </p>
              <div className="flex gap-5 pt-6">
                <a href="https://instagram.com/clover.bcn" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#9B7E6B]/20 flex items-center justify-center text-[#D4C4B0] hover:bg-[#9B7E6B] hover:text-white transition-all duration-300 hover:scale-110">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                  </svg>
                </a>
            ...
            <div className="space-y-5">
              <div className="text-[11px] font-bold tracking-[0.3em] text-[#9B7E6B] uppercase mb-8 flex items-center gap-3">
                <div className="w-8 h-[2px] bg-[#9B7E6B]"></div>
                Visita
              </div>
              <a href="#visita" className="block text-[16px] text-white/60 hover:text-[#D4C4B0] transition-colors font-light hover:translate-x-1 inline-block">
                Ubicación
              </a>
              <a href="#visita" className="block text-[16px] text-white/60 hover:text-[#D4C4B0] transition-colors font-light hover:translate-x-1 inline-block">
                Horarios
              </a>
              <a href="https://instagram.com/clover.bcn" target="_blank" rel="noopener noreferrer" className="block text-[16px] text-white/60 hover:text-[#D4C4B0] transition-colors font-light hover:translate-x-1 inline-block">
                Instagram
              </a>
            </div>
            ...
            <div className="space-y-5">
              ...
              <a
                href="tel:931259586"
                className="block text-[16px] text-white/60 hover:text-[#D4C4B0] transition-colors font-light hover:translate-x-1 inline-block"
              >
                931 25 95 86
              </a>
            </div>
          ...
          <div className="pt-12 border-t border-white/10">
            <p className="text-[14px] text-white/30 font-light text-center tracking-wide">
