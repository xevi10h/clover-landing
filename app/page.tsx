...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-white/98 backdrop-blur-md z-50 border-b border-[#E8E3D8]/40 shadow-sm">
        <div className="max-w-[1400px] mx-auto px-8 md:px-16 py-7">
          <div className="flex items-center justify-between">
            {/* CLOVER Logo with Clover Icon */}
            <div className="flex items-center gap-1 cursor-pointer group">
              <span className="text-[32px] font-light tracking-[0.15em] text-[#2d2d2d] group-hover:text-[#4A5F4F] transition-colors">CL</span>
              {/* Clover replacing O */}
              <svg className="w-7 h-7 text-[#4A5F4F] -mx-0.5" viewBox="0 0 40 40" fill="currentColor">
                <path d="M20 8c-2.2 0-4 1.8-4 4 0 1.5.8 2.8 2 3.5-.8.5-1.5 1.3-2 2.2C15.3 16.8 14.1 16 12.7 16c-2.2 0-4 1.8-4 4s1.8 4 4 4c1.4 0 2.6-.8 3.3-2 .5.9 1.2 1.7 2 2.2-1.2.7-2 2-2 3.5 0 2.2 1.8 4 4 4s4-1.8 4-4c0-1.5-.8-2.8-2-3.5.8-.5 1.5-1.3 2-2.2.7 1.2 1.9 2 3.3 2 2.2 0 4-1.8 4-4s-1.8-4-4-4c-1.4 0-2.6.8-3.3 2-.5-.9-1.2-1.7-2-2.2 1.2-.7 2-2 2-3.5 0-2.2-1.8-4-4-4z"/>
              </svg>
              <span className="text-[32px] font-light tracking-[0.15em] text-[#2d2d2d] group-hover:text-[#4A5F4F] transition-colors -ml-0.5">VER</span>
            </div>
            <div className="hidden md:flex items-center gap-14">
              <a href="#filosofia" className="text-[13px] font-normal tracking-[0.12em] text-[#6b6b6b] hover:text-[#4A5F4F] transition-all duration-300">Filosofía</a>
              <a href="#testimonios" className="text-[13px] font-normal tracking-[0.12em] text-[#6b6b6b] hover:text-[#4A5F4F] transition-all duration-300">Reseñas</a>
              <a href="#visita" className="text-[13px] font-normal tracking-[0.12em] text-[#6b6b6b] hover:text-[#4A5F4F] transition-all duration-300">Visita</a>
              <a
                href="https://instagram.com/clover.bcn"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#4A5F4F] hover:text-[#3D4F42] transition-colors duration-300"
              >
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-[#FAF8F4] via-[#FAF7F2] to-[#F0EBE3] flex items-center pt-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-20 items-center">
            <div className="space-y-12 max-w-2xl">
              <div className="space-y-8">
                <div className="inline-block px-6 py-2 bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 rounded-full">
                  <span className="text-[11px] font-semibold tracking-[0.25em] text-[#4A5F4F] uppercase">Barcelona · Eixample</span>
                </div>
                <h1 className="text-[clamp(70px,8vw,110px)] leading-[0.85] font-extralight tracking-[0.12em] text-[#2d2d2d] mb-10">
                  CLOVER
                </h1>
                <h2 className="text-[clamp(38px,5vw,58px)] leading-[1.1] font-light text-[#4A5F4F]">
              ...
              <div className="flex flex-col sm:flex-row gap-5 pt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group inline-block text-center px-14 py-6 bg-[#4A5F4F] text-white text-[13px] font-semibold tracking-[0.2em] hover:bg-[#3D4F42] transition-all duration-400 shadow-lg hover:shadow-2xl hover:-translate-y-0.5 uppercase"
                >
                  Ver Instagram
                </a>
                <a
                  href="tel:931259586"
                  className="inline-block text-center px-14 py-6 border-2 border-[#4A5F4F] text-[#4A5F4F] text-[13px] font-semibold tracking-[0.2em] hover:bg-[#4A5F4F] hover:text-white transition-all duration-400 hover:shadow-lg uppercase"
                >
                  Llamar Ahora
                </a>
              </div>
              <div className="flex items-center gap-10 pt-10 flex-wrap">
                <div className="flex items-center gap-4">
                  <div className="w-[3px] h-16 bg-gradient-to-b from-[#4A5F4F] to-[#E8E3D8]"></div>
                  <div>
            ...
            <div className="relative h-[750px] w-full">
              <div className="absolute inset-0 bg-gradient-to-br from-[#4A5F4F]/20 to-[#3D4F42]/20 rounded-2xl transform rotate-3"></div>
      ...
      <section id="filosofia" className="py-48 bg-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#4A5F4F]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#E8E3D8]/30 rounded-full blur-3xl"></div>
        <div className="max-w-[1500px] mx-auto px-8 md:px-16 relative z-10">
          <div className="text-center mb-32">
            <div className="inline-block px-6 py-2 bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 rounded-full mb-8">
              <span className="text-[11px] font-semibold tracking-[0.3em] text-[#4A5F4F] uppercase">Nuestra Filosofía</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="group text-center hover:-translate-y-2 transition-all duration-500">
                ...
                <div className="text-[48px] text-[#4A5F4F] mb-6 group-hover:scale-110 transition-transform duration-300">{feature.icon}</div>
      ...
      {/* Experience Section */}
      <section className="py-48 bg-gradient-to-b from-[#FAF7F2] to-[#FAF8F4]">
        <div className="max-w-[1400px] mx-auto px-8 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-10 order-1 lg:order-2">
              <div className="inline-block px-6 py-2 bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 rounded-full">
                <span className="text-[11px] font-semibold tracking-[0.3em] text-[#4A5F4F] uppercase">Experiencia Única</span>
              </div>
              ...
              <div className="pt-8">
                <a
                  href="#visita"
                  className="inline-block px-14 py-6 bg-[#4A5F4F] text-white text-[13px] font-semibold tracking-[0.2em] hover:bg-[#3D4F42] transition-all duration-400 shadow-lg hover:shadow-2xl uppercase"
                >
                  Cómo Llegar
                </a>
              </div>
      ...
      <section id="testimonios" className="py-48 bg-gradient-to-br from-[#4A5F4F] via-[#A0826D] to-[#3D4F42] relative overflow-hidden">
        ...
        <div className="max-w-[1500px] mx-auto px-8 md:px-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-white/95 backdrop-blur-sm p-14 rounded-2xl space-y-8 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 border border-white/20">
                <div className="text-[28px] text-[#4A5F4F]">★★★★★</div>
                <p className="text-[20px] leading-[1.8] text-[#2d2d2d] font-light italic">
                  &ldquo;{testimonial.quote}&rdquo;
                </p>
                <p className="text-[16px] font-semibold text-[#4A5F4F] tracking-wide">
                  — {testimonial.author}
                </p>
              </div>
            ))}
          ...
          <div className="text-center mt-20">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-14 py-6 border-2 border-white text-white text-[13px] font-semibold tracking-[0.2em] hover:bg-white hover:text-[#4A5F4F] transition-all duration-400 rounded-full uppercase backdrop-blur-sm"
            >
              Leer Más Reseñas
            </a>
          </div>
      ...
      <section className="py-48 bg-white">
        <div className="max-w-[1500px] mx-auto px-8 md:px-16">
          <div className="text-center mb-28">
            <div className="inline-block px-6 py-2 bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 rounded-full mb-8">
              <span className="text-[11px] font-semibold tracking-[0.3em] text-[#4A5F4F] uppercase">Síguenos</span>
            </div>
            ...
            {[
              ...
              <div key={idx} className="relative h-[280px] md:h-[350px] overflow-hidden rounded-xl group cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  className="object-cover group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#4A5F4F]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
          ...
          <div className="text-center mt-20">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-4 px-14 py-6 bg-gradient-to-r from-[#4A5F4F] to-[#3D4F42] text-white text-[13px] font-semibold tracking-[0.2em] hover:shadow-2xl transition-all duration-400 rounded-full uppercase group"
            >
      ...
      <section className="py-36 bg-gradient-to-br from-[#2d2d2d] via-[#3a3a3a] to-[#2d2d2d] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#4A5F4F] rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#E8E3D8] rounded-full blur-3xl"></div>
        </div>
        <div className="max-w-[900px] mx-auto px-8 md:px-16 text-center relative z-10">
          <div className="inline-block px-6 py-2 bg-[#4A5F4F]/20 border border-[#4A5F4F]/30 rounded-full mb-10">
            <span className="text-[11px] font-semibold tracking-[0.3em] text-[#E8E3D8] uppercase">Mantente Informado</span>
          </div>
          <h2 className="text-[clamp(40px,5vw,60px)] font-light tracking-wide text-white mb-8 leading-tight">
            Únete a nuestra comunidad
          </h2>
          <p className="text-[20px] text-[#E8E3D8] font-light mb-14 leading-relaxed">
          ...
          <form className="flex flex-col sm:flex-row gap-5 max-w-2xl mx-auto">
            <input
              ...
              className="flex-1 px-8 py-6 bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-[#4A5F4F] focus:bg-white/15 transition-all rounded-full text-[15px]"
            />
            <button type="submit" className="px-14 py-6 bg-[#4A5F4F] text-white text-[13px] font-semibold tracking-[0.2em] hover:bg-[#A0826D] transition-all duration-400 rounded-full shadow-lg hover:shadow-2xl uppercase">
              Suscribirse
            </button>
          </form>
      ...
      <section id="visita" className="py-48 bg-gradient-to-b from-white to-[#FAF7F2]">
        <div className="max-w-[1500px] mx-auto px-8 md:px-16">
          <div className="text-center mb-32">
            <div className="inline-block px-6 py-2 bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 rounded-full mb-8">
              <span className="text-[11px] font-semibold tracking-[0.3em] text-[#4A5F4F] uppercase">Ubicación</span>
            </div>
            <h2 className="text-[clamp(48px,6vw,72px)] font-light tracking-wide text-[#2d2d2d] mb-10">
              Visítanos
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-24 items-start">
            <div className="space-y-16">
              <div className="space-y-5 group hover:translate-x-2 transition-transform duration-300">
                <div className="text-[11px] font-bold tracking-[0.3em] text-[#4A5F4F] uppercase flex items-center gap-3">
                  <div className="w-8 h-[2px] bg-[#4A5F4F]"></div>
                  Dirección
                </div>
              ...
              <div className="space-y-5 group hover:translate-x-2 transition-transform duration-300">
                ...
                <a
                  href="tel:931259586"
                  className="text-[26px] text-[#2d2d2d] hover:text-[#4A5F4F] transition-colors font-light block"
                >
                  931 25 95 86
                </a>
              </div>
              ...
              <div className="space-y-5 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="text-[19px] text-[#2d2d2d] space-y-3 font-light">
                  <div className="flex justify-between max-w-md p-4 rounded-lg hover:bg-[#FAF7F2] transition-colors">
                    ...
                    <span className="text-[#4A5F4F]">10:00 - 20:30</span>
                  </div>
                  <div className="flex justify-between max-w-md p-4 rounded-lg hover:bg-[#FAF7F2] transition-colors">
                    <span className="font-medium">Sábados</span>
                    <span className="text-[#4A5F4F]">10:00 - 21:00</span>
                  </div>
                  <div className="flex justify-between max-w-md p-4 rounded-lg hover:bg-[#FAF7F2] transition-colors">
              ...
              <div className="pt-8">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-4 text-[#4A5F4F] hover:text-[#3D4F42] transition-colors text-[19px] font-medium group"
                >
            ...
            <div className="relative h-[750px] bg-[#FAF8F4] rounded-2xl overflow-hidden shadow-2xl group">
              <Image
          ...
          <div className="mt-24 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-16 py-7 bg-gradient-to-r from-[#4A5F4F] to-[#3D4F42] text-white text-[13px] font-semibold tracking-[0.2em] hover:shadow-2xl transition-all duration-400 rounded-full uppercase group"
            >
      ...
      <footer className="bg-gradient-to-br from-[#1a1a1a] via-[#2d2d2d] to-[#1a1a1a] py-32 relative overflow-hidden">
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#4A5F4F] rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#E8E3D8] rounded-full blur-3xl"></div>
        </div>

        {/* Decorative line */}
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#4A5F4F]/30 to-transparent"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.9fr_0.9fr] gap-24 mb-24">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="w-16 h-[2px] bg-gradient-to-r from-[#4A5F4F] to-transparent"></div>
              </div>
              <p className="text-[18px] text-[#E8E3D8]/80 font-light leading-[1.8] max-w-md">
              ...
              <div className="flex gap-4 pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-14 h-14 rounded-full bg-[#4A5F4F]/10 border border-[#4A5F4F]/20 flex items-center justify-center text-[#E8E3D8] hover:bg-[#4A5F4F] hover:border-[#4A5F4F] hover:text-white transition-all duration-400 hover:scale-110 hover:shadow-lg hover:shadow-[#4A5F4F]/20"
                >
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-3">
                  <div className="w-10 h-[1px] bg-[#4A5F4F]"></div>
                  <h3 className="text-[12px] font-bold tracking-[0.3em] text-[#4A5F4F] uppercase">Visita</h3>
                </div>
              </div>
              <nav className="space-y-5">
                <a
                  href="#visita"
                  className="group flex items-center gap-3 text-[17px] text-white/50 hover:text-[#E8E3D8] transition-all duration-300 font-light"
                >
                  <span className="w-0 h-[1px] bg-[#4A5F4F] group-hover:w-4 transition-all duration-300"></span>
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-3">
                  <div className="w-10 h-[1px] bg-[#4A5F4F]"></div>
                  <h3 className="text-[12px] font-bold tracking-[0.3em] text-[#4A5F4F] uppercase">Contacto</h3>
                </div>
              </div>
              <div className="space-y-6">
                ...
                <a
                  href="tel:931259586"
                  className="group inline-flex items-center gap-3 text-[17px] text-white/50 hover:text-[#E8E3D8] transition-all duration-300 font-light"
                >
                  <span className="w-0 h-[1px] bg-[#4A5F4F] group-hover:w-4 transition-all duration-300"></span>
          ...
          <div className="pt-16 border-t border-white/5">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-6">
                <a href="#" className="text-[13px] text-white/25 hover:text-[#E8E3D8] transition-colors font-light">
